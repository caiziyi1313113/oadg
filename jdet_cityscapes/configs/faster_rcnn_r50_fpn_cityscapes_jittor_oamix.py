...
# 训练输出目录和数据集目录
name = "faster_rcnn_r50_fpn_cityscapes_coco_jdet_oamix"

if os.name == "nt":
    work_dir = r"D:\sim2real\OA-DG\jdet_cityscapes\work_dirs\faster_rcnn_r50_fpn_cityscapes_coco_jdet_oamix"
    cityscapes_root = r"D:\sim2real\OA-DG\ws\data\cityscapes"
else:
    work_dir = "/mnt/d/sim2real/OA-DG/jdet_cityscapes/work_dirs/faster_rcnn_r50_fpn_cityscapes_coco_jdet_oamix"
